...
Thank you very much for your trust. We are happy that you have chosen our Charge Control V to
...
The Charge Control V is an IEC 61851 and ISO 15118 compliant charging controller for a dual-gun
Electric Vehicle Supply Equipment (EVSE). For communication between EVSE and PEV it supports Control Pilot,
Proximity Pilot as well as PWM signaling including Green PHY communication.

The Charge Control V is a future-proof powerhouse based on i.MX93 with universal compatibility, advanced
...
The Charge Control V is provided with a Linux-Yocto operating system. The installed software is based on
...
* Support for two independend charging ports (connectors/guns)
* Dedicated co-processors monitor and control safety-critical components like CP and PP signals,
...
.. warning::
  ...
  * **Attention!** Make sure that the device is not exposed to heat sources which may lead to overheating.
    Charge Control V can be damaged in case of overheating.
  * **Attention!** Ensure adequate ventilation at the site of installation. Charge Control V can be
    damaged in case of overheating.
  * **Attention!** The device may only be connected in the range of overvoltage category 3 or lower.
    Operating Charge Control V in a higher category can damage the device.
  * **Attention!** Do not operate the device in supply networks which do not comply with the
    specifications on the type plate. Operating Charge Control V in networks not compatible with
    the specifications on the type plate can damage the device.
  * **Attention!** The device may only be installed in dry areas. Exposing Charge Control V to wetness
...
You can acquire an Evaluation Kit using the order code 'CBCCV-xxx-xxxx'.
For more information on different models and peripheral of the Charge Control V,
